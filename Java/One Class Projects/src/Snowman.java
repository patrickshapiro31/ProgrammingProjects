...
public class Snowman extends Application
{
    ...
    {
        Text name = new Text(50, 50, "Patrick Shapiro");
        ...
        Circle bottomestButton = new Circle(80, 160, 6);
        bottomestButton.setFill(Color.RED);
        ...
        Group snowman = new Group(base, middle, head, leftEye, rightEye,
            mouth, topButton, bottomButton, bottomestButton, leftArm, rightArm, hat);
